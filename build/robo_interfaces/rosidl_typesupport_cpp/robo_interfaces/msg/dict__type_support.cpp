...
static const _Dict_type_support_symbol_names_t _Dict_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_interfaces, msg, Dict)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_interfaces, msg, Dict)),
  }
};
...
{
  return &::robo_interfaces::msg::rosidl_typesupport_cpp::Dict_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_interfaces, msg, Dict)() {
  return get_message_type_support_handle<robo_interfaces::msg::Dict>();
}
